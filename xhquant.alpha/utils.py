...
def get_clean_factor(factor,
    ...
    if groupby is not None:
        if isinstance(groupby, dict):
            ...
            groupby = pd.Series(index=factor_copy.index, data=ss[factor_copy.index.get_level_values('asset')].values)
    ...
    quantile_data = quantize_factor(merged_data, quantiles, bins, binning_by_group, no_raise, zero_aware)
